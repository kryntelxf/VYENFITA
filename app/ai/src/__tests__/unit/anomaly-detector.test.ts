/**
 * VYENFITA Anomaly Detector Unit Tests
 * 
 * @version 1.0.0
 */
...
describe('AnomalyDetector', () => {
  ...
  describe('iqr method', () => {
    ...
    it('should compute IQR bounds', () => {
      ...
      expect(result.statistics.q3).toBeGreaterThan(result.statistics.iqr);
    });
  });

  describe('edge cases', () => {
    it('should handle insufficient data', () => {
      expect(AnomalyDetector.detect([1, 2, 3]).hasAnomalies).toBe(false);
    });
